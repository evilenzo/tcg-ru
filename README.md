...
2. Запустите. Папку игры установщик найдёт сам через Steam (если нет — укажите её
   кнопкой «Обзор…») и нажмите **«Установить»**. Он сделает бэкап оригинала,
   соберёт перевод и поставит его (~1 мин).
...
запустить установщик ещё раз и нажать **«Удалить»**. После обновления игры через Steam —
